package com.fredericho.pokedex_compose.data.entity
...
data class Pokemon(
    ...
    val typeOfPokemon: List<TypePokemon>? = null,
...
fun Pokemon.color(): Int {
    val type = typeOfPokemon?.elementAtOrNull(0)?.name

    return when (type?.lowercase()) {
        "grass", "bug" -> R.color.poke_green
...
val pokemons = listOf(
    Pokemon(
        ...
        typeOfPokemon = listOf(TypePokemon(name = "Grass", color = R.color.poke_green), TypePokemon(name = "Poison", color = R.color.poke_purple)),
        category = "Seed",
    ...
    Pokemon(
        ...
        typeOfPokemon = listOf(TypePokemon(name = "Fire", color = R.color.poke_light_red)),
        category = "Lizard",
    ...
    Pokemon(
        ...
        typeOfPokemon = listOf(TypePokemon(name = "Water", color = R.color.poke_light_blue)),
    ...
    Pokemon(
        ...
        typeOfPokemon = listOf(TypePokemon(name = "Water", color = R.color.poke_light_teal)),
        category = "Worm",
    ...
    Pokemon(
        ...
        typeOfPokemon = listOf(TypePokemon(name = "Water", color = R.color.poke_light_teal), TypePokemon(name = "Flying", color = R.color.poke_light_blue)),
        category = "Butterfly",
    ...
    Pokemon(
        ...
        typeOfPokemon = listOf(TypePokemon(name = "Bug", color = R.color.poke_green), TypePokemon(name = "Poison", color = R.color.poke_purple)),
        category = "Hairy Bug",
    ...
    Pokemon(
        ...
        typeOfPokemon = listOf(TypePokemon(name = "Normal", color = R.color.poke_light_blue), TypePokemon(name = "Flying", color = R.color.poke_light_blue)),
        category = "Tiny Bird",
    ...
    Pokemon(
        ...
        typeOfPokemon = listOf(TypePokemon(name = "Normal", color = R.color.poke_light_blue)),
        category = "Mouse",
    ...
    Pokemon(
        ...
        typeOfPokemon = listOf(TypePokemon(name = "Poison", color = R.color.poke_purple)),
        category = "Snake",
    ...
    Pokemon(
        ...
        typeOfPokemon = listOf(TypePokemon(name = "Electric", color = R.color.poke_light_yellow)),
        category = "Mouse",
    ...
    Pokemon(
        ...
        typeOfPokemon = listOf(TypePokemon(name = "Ground", color = R.color.poke_light_brown)),
        category = "Mouse",
